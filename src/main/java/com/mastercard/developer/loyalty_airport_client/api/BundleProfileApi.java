...
public class BundleProfileApi {
    ...
    public com.squareup.okhttp.Call createUserCall(BundleUser bundleUser, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/bundle/profile/reference/users";
    ...
    public com.squareup.okhttp.Call patchUserCall(String userId, BundleUserPatch bundleUserPatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/bundle/profile/users/{user_id}/patch"
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call readConsentCall(String userId, String product, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/bundle/profile/users/{user_id}/products/{product}/consents"
            .replaceAll("\\{" + "user_id" + "\\}", apiClient.escapeString(userId.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call readConsentValidateBeforeCall(String userId, String product, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = readConsentCall(userId, product, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BundleUserResponse readConsent(String userId, String product) throws ApiException {
        ApiResponse<BundleUserResponse> resp = readConsentWithHttpInfo(userId, product);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BundleUserResponse> readConsentWithHttpInfo(String userId, String product) throws ApiException {
        com.squareup.okhttp.Call call = readConsentValidateBeforeCall(userId, product, null, null);
        Type localVarReturnType = new TypeToken<BundleUserResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call readConsentAsync(String userId, String product, final ApiCallback<BundleUserResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = readConsentValidateBeforeCall(userId, product, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BundleUserResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call readUserCall(String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/bundle/profile/users/{user_id}"
            .replaceAll("\\{" + "user_id" + "\\}", apiClient.escapeString(userId.toString()));
