...
public class User {
  ...
  **/
  ...
  public User userId(String userId) {
   ...
   /**
   * Unique, opaque identifier for the user as defined by the provisioning client, per RFC-7643 (https://tools.ietf.org/html/rfc7643).  The allowed values are compliant to RFC-2396 (https://tools.ietf.org/html/rfc2396), and allow for alphanumeric characters [a-z, A-Z, 0-9] and unreserved punctuation mark characters [-_.!~*&#39;()]
   * @return userId
  **/
  @ApiModelProperty(example = "user123-partnerBank", value = "Unique, opaque identifier for the user as defined by the provisioning client, per RFC-7643 (https://tools.ietf.org/html/rfc7643).  The allowed values are compliant to RFC-2396 (https://tools.ietf.org/html/rfc2396), and allow for alphanumeric characters [a-z, A-Z, 0-9] and unreserved punctuation mark characters [-_.!~*'()]")
